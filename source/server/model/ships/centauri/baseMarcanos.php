<?php
class BaseMarcanos extends SmallStarBaseFourSections{
	function __construct($id, $userid, $name,  $slot){
		...
		$this->phpclass = "BaseMarcanos";
		$this->shipClass = "Centauri Marcanos Base";
		$this->imagePath = "img/ships/base_marcanos.png";
